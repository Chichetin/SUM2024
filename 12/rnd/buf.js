class _uniformBlock {
  constructor(shd, name) {
    ...
    this.size = shd.rnd.gl.getActiveUniformBlockParameter(
      shd.prg,
      this.index,
      shd.rnd.gl.UNIFORM_BLOCK_DATA_SIZE,
    );
    this.bind = shd.rnd.gl.getActiveUniformBlockParameter(
      shd.prg,
      this.index,
      shd.rnd.gl.UNIFORM_BLOCK_BINDING,
    );
    ...
    shd.rnd.gl.bufferData(
      shd.rnd.gl.UNIFORM_BUFFER,
      this.size,
      shd.rnd.gl.DYNAMIC_DRAW,
    );
    shd.rnd.gl.bindBufferBase(
      shd.rnd.gl.UNIFORM_BUFFER,
      this.bind,
      this.buffer,
    );
...
function uniformBlock(shd, name) {
  return new _uniformBlock(shd, name);
}
